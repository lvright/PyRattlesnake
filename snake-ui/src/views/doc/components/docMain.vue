  ...
  <el-container>
    <el-header>
      <div class="logo">
        ...
        <span class="sys_name">PyRattlesnake</span>
      </div>
    ...
    <el-footer class="footer">
      PyRattlesnake {{ $CONFIG.APP_VER }} Copyright © 2021-2022 PyRattlesnake.com All Rights Reserved.
    </el-footer>
  </el-container>
</template>
...
.logo {
  ...
  .sys_name {
    color: #fff; background: rgb(220,38,38);
    padding: 0 4px; border-radius: 2px; font-family: inherit;
  }
}
.footer {
