...
from backend.scheams import Token, Result, DictDate, DictType
...
async def update_dict_type(dict_type: DictType, db: AsyncSession = Depends(get_db), token: str = Depends(check_jwt_token)):
