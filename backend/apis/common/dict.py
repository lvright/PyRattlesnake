...
async def update_dict_data(id: int, dict_type: DictClassify, db: AsyncSession = Depends(get_db),
                           token: str = Depends(check_jwt_token)):
...
async def update_dict_type(id: int, dict_type: DictClassify, db: AsyncSession = Depends(get_db),
                           token: str = Depends(check_jwt_token)):
    await getDictType.update(db, id, obj_in=dict_type.dict())
...
async def save_dict_type(dict_type: DictClassify, db: AsyncSession = Depends(get_db),
                         token: str = Depends(check_jwt_token)):
...
async def change_status_dict_type(dict_type: ChangeStatus, db: AsyncSession = Depends(get_db),
                                  token: str = Depends(check_jwt_token)):
...
async def delete_dict_type(dict_type: Ids, db: AsyncSession = Depends(get_db), token: str = Depends(check_jwt_token)):
...
async def sort_operation_dict_type(dict_type: ChangeSort, db: AsyncSession = Depends(get_db),
                                   token: str = Depends(check_jwt_token)):
...
async def update_dict_data(id: int, dict_data: DictDate, db: AsyncSession = Depends(get_db),
                           token: str = Depends(check_jwt_token)):
...
async def save_dict_data(dict_data: DictDate, db: AsyncSession = Depends(get_db),
                         token: str = Depends(check_jwt_token)):
...
async def change_dict_data(dict_data: ChangeStatus, db: AsyncSession = Depends(get_db),
                           token: str = Depends(check_jwt_token)):
...
async def delete_dict_data(dict_data: Ids, db: AsyncSession = Depends(get_db), token: str = Depends(check_jwt_token)):
...
async def sort_operation_dict_data(dict_data: ChangeSort, db: AsyncSession = Depends(get_db),
                                   token: str = Depends(check_jwt_token)):
...
async def recovery_dict_data(dict_data: Ids, db: AsyncSession = Depends(get_db), token: str = Depends(check_jwt_token)):
...
async def recovery_dict_type(dict_type: Ids, db: AsyncSession = Depends(get_db), token: str = Depends(check_jwt_token)):
...
async def get_dict_type_page(page: int, pageSize: int, orderBy: Optional[str] = "", orderType: Optional[str] = "",
                             name: Optional[str] = "", code: Optional[str] = "",maxDate: Optional[str] = "",
                             minDate: Optional[str] = "", status: Optional[str] = "",db: AsyncSession = Depends(get_db),
                             token: str = Depends(check_jwt_token)):
...
async def recycle_dict_type(page: int, pageSize: int, orderBy: Optional[str] = "", orderType: Optional[str] = "",
                            name: Optional[str] = "",code: Optional[str] = "",maxDate: Optional[str] = "",
                            minDate: Optional[str] = "", status: Optional[str] = "",db: AsyncSession = Depends(get_db),
                            token: str = Depends(check_jwt_token)):
    query_obj = {"name": name, "code": code, "status": status, "maxDate": maxDate, "minDate": minDate}
...
async def get_dict_data_page(page: int, pageSize: int, orderBy: Optional[str] = "", orderType: Optional[str] = "",
                             name: Optional[str] = "",code: Optional[str] = "", type_id: Optional[int] = None,
...
async def recycle_dict_data(page: int, pageSize: int, orderBy: Optional[str] = "", orderType: Optional[str] = "",
                            name: Optional[str] = "",code: Optional[str] = "", type_id: Optional[int] = None,
                            maxDate: Optional[str] = "",minDate: Optional[str] = "",status: Optional[str] = "",
                            db: AsyncSession = Depends(get_db), token: str = Depends(check_jwt_token)):
    query_obj = {"name": name, "code": code, "status": status, "type_id": type_id, "maxDate": maxDate,
