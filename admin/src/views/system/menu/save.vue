  ...
  <el-row>
    <el-col :xl="12" :lg="16">
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="80px" label-position="right">
        ...
        <el-form-item label="代码标识" prop="name">
          <el-input v-model="form.name" clearable placeholder="菜单代码"></el-input>
        ...
        <el-form-item label="是否隐藏" prop="hidden" v-if="form.type != 'B'">
    ...
    data(){
      return {
        ...
        rules: {
          ...
          name:  [{ required: true, message: '请输入标识代码', trigger: 'blur' }],
